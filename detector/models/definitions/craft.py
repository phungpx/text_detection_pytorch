...
class CRAFT(nn.Module):
    def __init__(self, pretrained=False, freeze=False):
        ...
        """ U network """
        self.upconv1 = double_conv(in_channels=1024, mid_channels=512, out_channels=256)
        self.upconv2 = double_conv(in_channels=512, mid_channels=256, out_channels=128)
        self.upconv3 = double_conv(in_channels=256, mid_channels=128, out_channels=64)
...
if __name__ == '__main__':
    ...
    output, feature = model(torch.randn(1, 3, 768, 768).to(device))
    print(output.shape)
    print(feature.shape)
