...
if __name__ == '__main__':
    ...
    dummy_input = torch.FloatTensor(4, 3, 640, 640).to(device)
    ...
    static_dict = torch.load('../../weights/word_detection/PANNet/PAN_shufflenetv2_FPEM_FFM.pth', map_location='cpu')
